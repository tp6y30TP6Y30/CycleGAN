...
def generateGIFs(query, target_img_name, save_folder, interval = 20, mode = 'gif'):
	print('Saving GIF...')
	print('query: ', query)
	...
	if mode == 'gif':
		...
		target_gif_name = target_img_name.replace('.jpg', '.mp4')
		imageio.mimsave(os.path.join(save_path, target_gif_name), images, fps = 1)
...
if __name__ == '__main__':
	# generateGIFs(query = 'horse2zebra', target_img_name = 'fake_A91.jpg', save_folder = 'GIFs/', mode = 'mp4')
